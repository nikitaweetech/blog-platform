...
const PostCard = ({
  ...
  return (
    <div className="bg-white rounded-b-lg shadow-md overflow-hidden flex flex-col">
        ...
        <div className="p-6 flex-grow flex-col">
            ...
            <Link  className="text-indigo-600 hover:underline mt-auto  text-right block" href={`/blog/${slug}/${id}`}>Read More</Link>
        </div>
